...
`v` is a content hash of kiosk client assets (index.html and any other
files listed in SOURCES), not the latest git SHA. Pages also deploys
when x-status.json refreshes; hashing code means those data-only deploys
do not bounce wall iPads.
